...
def create_app(config: Optional[SystemConfig] = None) -> Flask:
    ...
    @app.route('/api/hr-chatbot/health', methods=['GET'])
    def health():
        """Health check"""
    ...
    @app.route('/api/hr-chatbot/config', methods=['GET'])
    def get_config():
        """Get configuration"""
        return jsonify({
    ...
    @app.route('/api/hr-chatbot/ask', methods=['POST', 'OPTIONS'])
    def ask_post():
        """Ask a question (POST)"""
    ...
    @app.route('/api/hr-chatbot/ask/<path:question>', methods=['GET', 'OPTIONS'])
    ...
    def api_docs():
        ...
        return jsonify({
            ...
            "version": "2.0",
            "endpoints": {
                "GET /api/hr-chatbot/health": "Health check",
                "GET /api/hr-chatbot/config": "Get configuration",
                "POST /api/hr-chatbot/ask": "Ask question (JSON body with 'question' field)",
                "GET /api/hr-chatbot/ask/<question>": "Ask question (URL-encoded)"
            }
        })
